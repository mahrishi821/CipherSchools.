...
const Video = () => {
  ...
  return (
    <Stack direction={['column', 'row']} h={'100vh'} backgroundColor={'blackAlpha.900'}>

      <VStack w={'full'} > 
        <video src={videoSrc} controls controlsList='nodownload' style={ {width : '100%'} }></video>

         <VStack  alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'} color={'white'}>
            <Heading>Sample Text 1</Heading>
            <Text>
