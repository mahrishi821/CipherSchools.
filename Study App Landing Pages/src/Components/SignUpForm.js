...
const SignUpForm = ({ setIsLoggedIn }) => {
    ...
    const [cnfshowPassword, cnfsetShowPassword] = useState(false)
            ...
            <form onSubmit={submitHandler}>
                ...
                <div className='mt-[20px]'>
                    <label className='w-full mt-[20px]'>
                        ...
                        <input className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' required type='email' name='email' onChange={changeHandler} placeholder='Enter email' value={formData.email}></input>
                    </label>
                </div>
                ...
                <div className='w-full flex gap-x-4 mt-[20px]'>
                    <label className='w-full relative'>
                        ...
                        <input className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' required type={showPassword ? "password" : "text"} name='password' onChange={changeHandler} placeholder='Enter Password' value={formData.password}></input>
                    ...
                    <label className='w-full relative'>
                        ...
                        <input className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' required type={cnfshowPassword ? "password" : "text"} name='confirmpassword' onChange={changeHandler} placeholder='Confirm Password' value={formData.confirmpassword}></input>
                        <span className='absolute right-3 top-[38px] cursor-pointer' onClick={() => cnfsetShowPassword((prev) => !prev)}>
                            {cnfshowPassword ? <AiOutlineEyeInvisible fontSize={24} fill='#AFB2BF'></AiOutlineEyeInvisible> : <AiOutlineEye fontSize={24} fill='#AFB2BF'></AiOutlineEye>}
                        </span>
                    </label>
                </div>
